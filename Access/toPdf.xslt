...
<xsl:stylesheet xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:fox="http://xmlgraphics.apache.org/fop/extensions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
			...
			<fo:table-body>
				...
				<xsl:for-each select="tables/Filieres/Filiere">
					<fo:table-row border-bottom="1px solid #2F4F4F">
						...
						<fo:table-cell border-left="1px solid #2F4F4F" border-right="1px solid #2F4F4F">
							<fo:block>
								<xsl:value-of select="disignation"/>
							</fo:block>
						</fo:table-cell>
		...
		<fo:table background-color="#FFE4C4" border="2px solid #2F4F4F " padding-bottom="0.75cm" padding-top="15px">
			<fo:table-body>
				...
				<fo:table-row background-color="#A9A9A9" border-bottom="2px solid #2F4F4F">
					...
					<fo:table-cell border-left="1px solid #2F4F4F" border-right="1px solid #2F4F4F">
						<fo:block>semestre</fo:block>

					</fo:table-cell>
					<fo:table-cell border-left="1px solid #2F4F4F" border-right="1px solid #2F4F4F">
						<fo:block>code filiere</fo:block>
		...
		<fo:table background-color="#FFE4C4" border="2px solid #2F4F4F " padding-bottom="0.75cm" padding-top="15px">
			<fo:table-body>
				...
				<fo:table-row background-color="#A9A9A9" border-bottom="2px solid #2F4F4F">
					...
					<fo:table-cell border-left="1px solid #2F4F4F" border-right="1px solid #2F4F4F">
						<fo:block>code_matiere</fo:block>
